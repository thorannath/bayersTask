...
const NewDashboard = () => {
    ...
    const fetchData = () => {
        let req = {
            groupCondition: {
                groupBy: 'Payertype',
                selection: ['ckd', 'diab', 'both']
            },
            states: ['NY', 'AZ'],
            treatments: {
                labels: ['tx_plt', 'tx_lpd_statin', 'tx_plt', 'tx_lpd_statin', 'tx_plt', 'tx_lpd_statin', 'tx_plt', 'tx_lpd_statin', 'tx_plt', 'tx_lpd_statin','tx_plt', 'tx_lpd_statin'],
                OR: ['64', '65536'],
                AND: ['128', '256']
            },
            medicalConditions: {
